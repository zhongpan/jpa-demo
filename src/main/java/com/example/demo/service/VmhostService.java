...
public class VmhostService {
  ...
  // select vmhostpo0_.id as id1_2_, vmhostpo0_.addresses as addresse2_2_,
  // vmhostpo0_.availablezone as availabl3_2_, vmhostpo0_.baremetal as
  // baremeta4_2_, vmhostpo0_.cpucore as cpucore5_2_, vmhostpo0_.createtime as
  // createti6_2_, vmhostpo0_.disksize as disksize7_2_, vmhostpo0_.floatip as
  // floatip8_2_, vmhostpo0_.hostname as hostname9_2_, vmhostpo0_.locked as
  // locked10_2_, vmhostpo0_.metadata as metadat11_2_, vmhostpo0_.name as
  // name12_2_, vmhostpo0_.privatenetworkid as private13_2_, vmhostpo0_.ramsize as
  // ramsize14_2_, vmhostpo0_.tenantid as tenanti15_2_, vmhostpo0_.tenantname as
  // tenantn16_2_, vmhostpo0_.type as type17_2_, vmhostpo0_.userid as userid18_2_,
  // vmhostpo0_.username as usernam19_2_, vmhostpo0_.vmstatus as vmstatu20_2_ from
  // vmhost vmhostpo0_ cross join auth_user authuserpo1_ cross join auth_tenant
  // authtenant2_ where vmhostpo0_.userid=authuserpo1_.id and
  // vmhostpo0_.tenantid=authtenant2_.id and (vmhostpo0_.name like ?)
  public List<VmhostInfoDTO> listVmhostSpec(String name) {
