...
@Entity
@Table(name = "vmhost")
public class VmhostWithRelationPO {
  ...
  public AuthTenantPO getTenant() {
    return tenant;
  }

  public void setTenant(AuthTenantPO tenant) {
    this.tenant = tenant;
  }
  ...
  public void setUser(AuthUserPO user) {
    this.user = user;
  }
